...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN:Ahmad Admin\n' 
            + 'ORG: Pengembang XBot;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=+60195042951:+60 195-042-951\n' 
            + 'END:VCARD' 
prefix = '#'
blocked = []          
/*********** LOAD FILE ***********/
...
const client = new WAConnection()
   ...
   console.log(color('[','white'),color('∆','red'),color(']','white'),color('qr already scan.subscribe','white'),color('YOU','red'),color('TUBE','white'),color('Iqbal Rizki Maulana','yellow'))
})
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["+60195042951@s.whatsapp.net"] 
